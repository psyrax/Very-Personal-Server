	...
	<div data-role="page"> 
		<div data-role="header">
			...
			<div data-role="navbar" class="ui-bar">
				<ul>
						<li><a href="<?= base_url(); ?>dashboard" data-prefetch> Dashboard </a></li>
						<li><a href="<?= base_url(); ?>trinfo/tinfo">Torrent manager</a></li>
						<li><a href="<?= base_url(); ?>dwnldr">MU Downloader</a></li>
						<li><a href="<?= base_url();?>login/gtfo">@<?= $this->session->userdata('username');?> GTFO!</a></li>
				</ul>
			</div>
		</div> 
